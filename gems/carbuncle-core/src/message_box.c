...
void mrb_carbuncle_show_fatal(const char *title, const char *message)
{
#ifdef __EMSCRIPTEN__
...
void mrb_carbuncle_show_error(mrb_state *mrb, mrb_value error)
{
...
void mrb_init_carbuncle_messagebox(mrb_state *mrb)
{
}
