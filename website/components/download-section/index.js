    ...
    <Panel stretch>
      ...
      <div className={styles.downloads}>
        <div className={styles.platform}>
          ...
          <a href="https://github.com/holywyvern/carbuncle/releases/download/0.6.1/win32-x64.zip">
            0.6.1 (x64)
          </a>
        </div>
        <div className={styles.platform}>
        ...
        <div className={styles.platform}>
          ...
          <h4>{t("Web Builds")}</h4>
          <a href="https://github.com/holywyvern/carbuncle/releases/download/0.6.1/web.zip">
            0.6.1
          </a>
        </div>
      </div>
